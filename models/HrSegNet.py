...
class HrSegNetB64(nn.Module):
    ...
    This code is adapted from HrSegNet4CrackSegmentation (https://github.com/CHDyshli/HrSegNet4CrackSegmentation/tree/main),
    originally licensed under Apache License 2.0.
    This adaptation is licensed under the MIT License.
